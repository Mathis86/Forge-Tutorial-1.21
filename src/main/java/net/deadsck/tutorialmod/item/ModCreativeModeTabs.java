...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> ALEXANDRITE_ORES_TAB = CREATIVE_MODE_TABS.register(
            "alexandrite_ores_tab",
            () -> CreativeModeTab.builder()
                    .withTabsBefore(ALEXANDRITE_ITEMS_TAB.getId())
                    .icon(() -> new ItemStack(ModBlocks.ALEXANDRITE_ORE.get()))
                    .title(Component.translatable("creativetab.tutorialmod.alexandrite_ores"))
                    .displayItems((itemDisplayParameters, output) -> {
    ...
    public static final RegistryObject<CreativeModeTab> ALEXANDRITE_BLOCKS_TAB = CREATIVE_MODE_TABS.register(
            ...
            () -> CreativeModeTab.builder()
                    .withTabsBefore(ALEXANDRITE_ORES_TAB.getId())
